namespace CarrierProj.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserRating", "RateID", "dbo.Rate");
            DropForeignKey("dbo.UserRating", "CarrierID", "dbo.Carrier");
            ...
            DropIndex("dbo.UserRating", new[] { "CarrierID" });
            DropIndex("dbo.UserRating", new[] { "RateID" });
